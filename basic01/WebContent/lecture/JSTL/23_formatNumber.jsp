...
<!--		<fmt:formatDate value="${ now }"></fmt:formatDate>
	date : <fmt:formatDate value="${ now }" type="date"></fmt:formatDate>
		default : <fmt:formatDate value="${ now }" type="default"></fmt:formatDate>
 		time : <fmt:formatDate value="${ now }" type="time"></fmt:formatDate>
		both : <fmt:formatDate value="${ now }" type="both"></fmt:formatDate>
		short : <fmt:formatDate value="${ now }" type="short"></fmt:formatDate>
		medium : <fmt:formatDate value="${ now }" type="medium"></fmt:formatDate>
		long : <fmt:formatDate value="${ now }" type="long"></fmt:formatDate>
		full : <fmt:formatDate value="${ now }" type="full"></fmt:formatDate>
